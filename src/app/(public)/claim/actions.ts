...
// created and credentials are emailed (see admin/actions.ts approveClaim). There is
// NO provider sign-up anywhere before this — verification is the gate. Inserted via
// the service-role admin client because the submitter has no session yet.
